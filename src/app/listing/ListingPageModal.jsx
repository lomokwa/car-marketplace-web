        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              <h2 className="text-sm title-font text-gray-400 tracking-widest">{car.year}</h2>
              <h1 className="text-gray-100 text-3xl title-font font-medium mb-4">{car.make} {car.model}</h1>
            ...
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={car.image} />
          </div>
        </div>
      </section>
    </div>
