...
export default function ListingPageModal ({ car, setShowListingPageModal }) {
  ...
  return(
    <>
      <div className="overscroll-none justify-center items-center flex overflow-x-hidden fixed inset-0 z-50 outline-none focus:outline-none h-full">
        <section className="bg-gray-100 dark:text-gray-200 dark:bg-gray-900 body-font overflow-hidden h-full w-full sm:h-[80%] sm:w-[70%]">
          <button
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              <a href={car.url} target="_blank" rel="noreferrer" className="md:w-1/2 w-full md:h-72 h-64 object-cover object-center rounded" >
                <img alt={`${car.make} ${car.model}`} src={car.image} className="sm:h-[400px] h-64 w-full object-cover" />
              </a>
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex">
                  ...
                  <button onClick={handleRatingClick} onAnimationEnd={() => setEffect(false)} className={`${effect && "animate-wiggle"} rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4`}>
