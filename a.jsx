      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">{car.year}</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">{car.make} {car.model}</h1>
            ...
            <div className="flex border-t border-gray-200 py-2">
              ...
              <span className="ml-auto text-gray-900">{car.mileage.toLocaleString()} Miles</span>
            </div>
            <div className="flex border-t border-gray-200 py-2">
              <span className="text-gray-500">Transmission:</span>
              <span className="ml-auto text-gray-900">{car.transmission}</span>
            </div>
            <div className="flex border-t mb-6 border-gray-200 py-2">
            </div>
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900">${car.price.toLocaleString()}</span>
          ...
          <img alt={`${car.make} ${car.model}`} className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={car.image} />
        </div>
      </div>
    </section>
  </div>
